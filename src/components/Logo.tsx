...
const Logo: React.FC = () => (
  <div className="flex justify-center items-center bg-slate-200 dark:bg-sky-900">
    <img src={iconWhite} alt="Logo" className="w-12 h-12 xl:w-16 xl:h-16 hidden dark:block" />
    <img src={iconDark} alt="Logo" className="w-12 h-12 xl:w-16 xl:h-16 block dark:hidden" />
  </div>
);
